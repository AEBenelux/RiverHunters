...
I.	1 x Sony Playstation;
II.	1 x Copy of “Beyond Blue” for Playstation 5 (please note this console is only compatible with British sockets);
III.	1 x One-Year Entry Subscription to Zee Aquarium; and
IV.	1 x History® Channel Hoodie. 
3.	To enter the Competition, you must subscribe to the History® Benelux YouTube Channel at https://www.youtube.com/channel/UCy2nFIhmaq5G66Y0BsPU42Q and answer the following question by commenting on the YouTube Channel page: “If you had the opportunity to go diving in any river in the entire world, which river would you pick and why?”  
...
8.	The draw will take place on 22 June 2021 at 14.00pm (GMT).  Before the draw can take place, all entries will be collated (“the Collated Entries”).  From the Collated Entries, only those with a correct answer will be put forward for selection to win a Prize.  
9.	The 1 Prize winner will be chosen at random from all of the correct entries and will be notified by email on 22 June 2021 (“the Notification Date”) and their eligibility to enter the Competition will then be confirmed. Once we have verified each winner’s eligibility (“Confirmation Date”), we will confirm all arrangements connected to the delivery and enjoyment of their Prize.  
